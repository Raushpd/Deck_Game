...
let restartBtn = document.getElementById("restart-btn");
    ...
    function drop(ev) {
        ...
        if((ev.target.id == 100 && cardId%4 == 3 )|| (ev.target.id == 101 && cardId%4 == 1) || (ev.target.id == 102 && cardId%4 == 0) || (ev.target.id == 103 && cardId%4 == 2))
    ...
    restartBtn.addEventListener("click", ()=>{
        let setCardsAgain = new RenderCards(appDiv,cardHolder, cardNames, cardHolderNames);
        setCardsAgain.start();
    })
